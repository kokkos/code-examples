...
struct CrsMatrix {
  ...
  CrsMatrix(Kokkos::View<INT_TYPE*,MemSpace> row_ptr_,
            ...
            INT_TYPE num_cols_):row_ptr(row_ptr_),col_idx(col_idx_),values(values_),_num_cols(num_cols_) {}
};

namespace Impl {
      template<class GO, class S>
      static void
      miniFE_get_row (INT_TYPE* rows, S* vals, GO* cols, INT_TYPE startrow,
                      INT_TYPE endrow, INT_TYPE& row,INT_TYPE o,INT_TYPE nx1,
                      INT_TYPE c1,INT_TYPE c2, INT_TYPE c3,INT_TYPE val,
                      INT_TYPE &miniFE_a,INT_TYPE &miniFE_b,INT_TYPE &miniFE_c)
      {
...
//printf("%li %li %li\n",c1,c2,c3);
       ...
       template<class GO, class S>
       static void miniFE_get_block(INT_TYPE* rows, S* vals, GO* cols,INT_TYPE startrow, INT_TYPE endrow,INT_TYPE& row , INT_TYPE o, INT_TYPE nx1, INT_TYPE c1, INT_TYPE c2,INT_TYPE val1,INT_TYPE val2,INT_TYPE val3,INT_TYPE &miniFE_a,INT_TYPE &miniFE_b,INT_TYPE &miniFE_c) {
       ...
       template<class GO, class S>
       static void miniFE_get_superblock(INT_TYPE* rows, S* vals, GO* cols,INT_TYPE startrow, INT_TYPE endrow,INT_TYPE& row , INT_TYPE o, INT_TYPE nx1, INT_TYPE c1,INT_TYPE val1,INT_TYPE val2,INT_TYPE val3,INT_TYPE &miniFE_a,INT_TYPE &miniFE_b,INT_TYPE &miniFE_c) {
      ...
      generate_miniFE_matrix (int nx)
      {
        ...
        Kokkos::View<INT_TYPE*,Kokkos::HostSpace> rowPtr("generate_MiniFE_Matrix::rowPtr",endrow-startrow+1);
        Kokkos::View<INT_TYPE*,Kokkos::HostSpace> colInd("generate_MiniFE_Matrix::colInd",(endrow-startrow)*27);
       ...
       generate_miniFE_vector( INT_TYPE nx) {

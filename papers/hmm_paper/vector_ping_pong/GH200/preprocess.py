...
def process_files(hardware: str, prefix: str, stride: str, ping: str, pong: str):
    ...
    INPUT_FILES = [];
    for size in sizes:
        INPUT_FILES.append(f'{hardware}_{prefix}_10_{size}_100_1000_{stride}_{ping}_{pong}.csv')
    ...
    for pong in pongs:
        for stride in strides:
            for prefix in prefixes:
                process_files(hardware, prefix, stride,ping,pong)

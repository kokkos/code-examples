...
Plots bandwidth (GB/s) and speed-up for a given kernel, grouped by rank (1-6).

Usage:
    python plot_cpu_stream.py kernel file1.json file2.json
...
def main():
    ...
    if len(filepaths) > 2:
        print("Warning: only the first 2 files will be used.")
